...
class Config:
	...
	@property
	def SERVERLOG_NOTIFICATIONS_OUT(self):
		return self.RESULTS_DIR + os.path.sep + "serverlog_analysis_notifications.json"
	@property
	def SERVERLOG_NOTIFICATIONS_DOMAINS_OUT(self):
		return self.RESULTS_DIR + os.path.sep + "serverlog_analysis_notifications_interesting.txt"
